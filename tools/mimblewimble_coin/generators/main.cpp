/*
This file can create the ../../../legacy/firmware/mimblewimble_coin_generators.c and ../../../core/embed/extmod/modtrezorcrypto/mimblewimble_coin_generators.c files by running the following commands:
...
./a.out ../../../core/embed/extmod/modtrezorcrypto/mimblewimble_coin_generators.c 3
*/
...
int main(int argc, char *argv[]) {
	...
	// Create file
	ofstream file(argv[1], ofstream::binary);
	
	// Get number of odd multiples
	const uint8_t numberOfOddMultiples = 1 << (atoi(argv[2]) - 2);
	...
	for(size_t i = 0; i < NUMBER_OF_GENERATORS; ++i) {
		...
		for(uint8_t j = 0; j < numberOfOddMultiples; ++j) {
			...
			file << '}' << endl << "\t}" << ((i != NUMBER_OF_GENERATORS - 1 || j != numberOfOddMultiples - 1) ? "," : "") << endl;
		}
	}
