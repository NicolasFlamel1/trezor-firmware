...
if utils.USE_THP:
    ...
    async def get_seed(progress_bar: bool = True) -> bytes:  # type: ignore [Function declaration "get_seed" is obscured by a declaration of the same name]
    ...
    if utils.BITCOIN_ONLY:
        ...
        async def derive_and_store_roots(
            ctx: Context, msg: ThpCreateNewSession, progress_bar: bool = True
        ) -> None:
