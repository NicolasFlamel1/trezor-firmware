...
trezor_message_impl! {
    ...
    MimbleWimbleCoinAddress => MessageType_MimbleWimbleCoinAddress,
    MimbleWimbleCoinGetSeedCookie => MessageType_MimbleWimbleCoinGetSeedCookie,
    MimbleWimbleCoinSeedCookie => MessageType_MimbleWimbleCoinSeedCookie,
    MimbleWimbleCoinGetCommitment => MessageType_MimbleWimbleCoinGetCommitment,
    MimbleWimbleCoinCommitment => MessageType_MimbleWimbleCoinCommitment,
    MimbleWimbleCoinGetBulletproofComponents => MessageType_MimbleWimbleCoinGetBulletproofComponents,
    MimbleWimbleCoinBulletproofComponents => MessageType_MimbleWimbleCoinBulletproofComponents,
    MimbleWimbleCoinVerifyRootPublicKey => MessageType_MimbleWimbleCoinVerifyRootPublicKey,
    MimbleWimbleCoinVerifyAddress => MessageType_MimbleWimbleCoinVerifyAddress,
    MimbleWimbleCoinStartEncryptingSlate => MessageType_MimbleWimbleCoinStartEncryptingSlate,
    MimbleWimbleCoinEncryptedSlateNonceAndSalt => MessageType_MimbleWimbleCoinEncryptedSlateNonceAndSalt,
    MimbleWimbleCoinContinueEncryptingSlate => MessageType_MimbleWimbleCoinContinueEncryptingSlate,
    MimbleWimbleCoinEncryptedSlateData => MessageType_MimbleWimbleCoinEncryptedSlateData,
    MimbleWimbleCoinFinishEncryptingSlate => MessageType_MimbleWimbleCoinFinishEncryptingSlate,
    MimbleWimbleCoinEncryptedSlateTagAndSignature => MessageType_MimbleWimbleCoinEncryptedSlateTagAndSignature,
    MimbleWimbleCoinStartDecryptingSlate => MessageType_MimbleWimbleCoinStartDecryptingSlate,
    MimbleWimbleCoinContinueDecryptingSlate => MessageType_MimbleWimbleCoinContinueDecryptingSlate,
    MimbleWimbleCoinDecryptedSlateData => MessageType_MimbleWimbleCoinDecryptedSlateData,
    MimbleWimbleCoinFinishDecryptingSlate => MessageType_MimbleWimbleCoinFinishDecryptingSlate,
    MimbleWimbleCoinDecryptedSlateAesKey => MessageType_MimbleWimbleCoinDecryptedSlateAesKey,
    MimbleWimbleCoinStartTransaction => MessageType_MimbleWimbleCoinStartTransaction,
    MimbleWimbleCoinContinueTransactionIncludeOutput => MessageType_MimbleWimbleCoinContinueTransactionIncludeOutput,
    MimbleWimbleCoinContinueTransactionIncludeInput => MessageType_MimbleWimbleCoinContinueTransactionIncludeInput,
    MimbleWimbleCoinContinueTransactionApplyOffset => MessageType_MimbleWimbleCoinContinueTransactionApplyOffset,
    MimbleWimbleCoinTransactionSecretNonceIndex => MessageType_MimbleWimbleCoinTransactionSecretNonceIndex,
    MimbleWimbleCoinContinueTransactionGetPublicKey => MessageType_MimbleWimbleCoinContinueTransactionGetPublicKey,
    MimbleWimbleCoinTransactionPublicKey => MessageType_MimbleWimbleCoinTransactionPublicKey,
    MimbleWimbleCoinContinueTransactionGetPublicNonce => MessageType_MimbleWimbleCoinContinueTransactionGetPublicNonce,
    MimbleWimbleCoinTransactionPublicNonce => MessageType_MimbleWimbleCoinTransactionPublicNonce,
    MimbleWimbleCoinContinueTransactionGetMessageSignature => MessageType_MimbleWimbleCoinContinueTransactionGetMessageSignature,
    MimbleWimbleCoinTransactionMessageSignature => MessageType_MimbleWimbleCoinTransactionMessageSignature,
    MimbleWimbleCoinFinishTransaction => MessageType_MimbleWimbleCoinFinishTransaction,
