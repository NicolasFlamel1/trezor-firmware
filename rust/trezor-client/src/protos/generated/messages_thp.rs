...
impl ::protobuf::Message for ThpDeviceProperties {
    ...
    fn is_initialized(&self) -> bool {
        ...
        if self.protocol_version_major.is_none() {
            return false;
        }
        if self.protocol_version_minor.is_none() {
            return false;
        }
        true
    }
...
impl ThpSelectMethod {
    ...
    // required .hw.trezor.messages.thp.ThpPairingMethod selected_pairing_method = 1;
...
impl ::protobuf::Message for ThpSelectMethod {
    ...
    fn is_initialized(&self) -> bool {
        if self.selected_pairing_method.is_none() {
            return false;
        }
        true
    }
...
pub struct ThpCredentialRequest {
    // message fields
    // @@protoc_insertion_point(field:hw.trezor.messages.thp.ThpCredentialRequest.host_static_public_key)
    ...
    // @@protoc_insertion_point(field:hw.trezor.messages.thp.ThpCredentialRequest.credential)
...
impl ThpCredentialRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            ...
            |m: &ThpCredentialRequest| { &m.host_static_public_key },
            |m: &mut ThpCredentialRequest| { &mut m.host_static_public_key },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "autoconnect",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "credential",
            |m: &ThpCredentialRequest| { &m.credential },
...
pub struct ThpCredentialResponse {
    // message fields
    // @@protoc_insertion_point(field:hw.trezor.messages.thp.ThpCredentialResponse.trezor_static_public_key)
    pub trezor_static_public_key: ::std::option::Option<::std::vec::Vec<u8>>,
...
impl ThpCredentialResponse {
    ...
    pub fn trezor_static_public_key(&self) -> &[u8] {
        match self.trezor_static_public_key.as_ref() {
            Some(v) => v,
            None => &[],
        }
    }

    pub fn clear_trezor_static_public_key(&mut self) {
        self.trezor_static_public_key = ::std::option::Option::None;
    }

    pub fn has_trezor_static_public_key(&self) -> bool {
        self.trezor_static_public_key.is_some()
    }

    // Param is passed by value, moved
    pub fn set_trezor_static_public_key(&mut self, v: ::std::vec::Vec<u8>) {
        self.trezor_static_public_key = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_trezor_static_public_key(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.trezor_static_public_key.is_none() {
            self.trezor_static_public_key = ::std::option::Option::Some(::std::vec::Vec::new());
        }
        self.trezor_static_public_key.as_mut().unwrap()
    }

    // Take field
    pub fn take_trezor_static_public_key(&mut self) -> ::std::vec::Vec<u8> {
        self.trezor_static_public_key.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            ...
            |m: &ThpCredentialResponse| { &m.trezor_static_public_key },
            |m: &mut ThpCredentialResponse| { &mut m.trezor_static_public_key },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "credential",
...
impl ::protobuf::Message for ThpCredentialResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.trezor_static_public_key = ::std::option::Option::Some(is.read_bytes()?);
                },
                18 => {
                    self.credential = ::std::option::Option::Some(is.read_bytes()?);
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.trezor_static_public_key.as_ref() {
            my_size += ::protobuf::rt::bytes_size(1, &v);
        }
        if let Some(v) = self.credential.as_ref() {
            my_size += ::protobuf::rt::bytes_size(2, &v);
    ...
    fn default_instance() -> &'static ThpCredentialResponse {
        static instance: ThpCredentialResponse = ThpCredentialResponse {
            trezor_static_public_key: ::std::option::Option::None,
            credential: ::std::option::Option::None,
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
...
impl ::protobuf::Message for ThpPairingCredential {
    ...
    fn is_initialized(&self) -> bool {
        if self.cred_metadata.is_none() {
            return false;
        }
        if self.mac.is_none() {
            return false;
        }
        for v in &self.cred_metadata {
            if !v.is_initialized() {
                return false;
            }
        };
...
pub struct ThpAuthenticatedCredentialData {
    // message fields
    // @@protoc_insertion_point(field:hw.trezor.messages.thp.ThpAuthenticatedCredentialData.host_static_public_key)
    pub host_static_public_key: ::std::option::Option<::std::vec::Vec<u8>>,
...
impl ThpAuthenticatedCredentialData {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "host_static_public_key",
            |m: &ThpAuthenticatedCredentialData| { &m.host_static_public_key },
            |m: &mut ThpAuthenticatedCredentialData| { &mut m.host_static_public_key },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, ThpCredentialMetadata>(
            "cred_metadata",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    airingRequest\x10\xf0\x07\x1a\x04\x90\xb5\x18\x01\x123\n(ThpMessageType_\
    ThpPairingRequestApproved\x10\xf1\x07\x1a\x04\x98\xb5\x18\x01\x12)\n\x1e\
    ThpMessageType_ThpSelectMethod\x10\xf2\x07\x1a\x04\x90\xb5\x18\x01\x128\
    \n-ThpMessageType_ThpPairingPreparationsFinished\x10\xf3\x07\x1a\x04\x98\
    \xb5\x18\x01\x122\n#ThpMessageType_ThpCredentialRequest\x10\xf8\x07\x1a\
    \x08\x80\xa6\x1d\x01\x90\xb5\x18\x01\x123\n$ThpMessageType_ThpCredential\
    Response\x10\xf9\x07\x1a\x08\x80\xa6\x1d\x01\x98\xb5\x18\x01\x12'\n\x1cT\
    hpMessageType_ThpEndRequest\x10\xfa\x07\x1a\x04\x90\xb5\x18\x01\x12(\n\
    \x1dThpMessageType_ThpEndResponse\x10\xfb\x07\x1a\x04\x98\xb5\x18\x01\
    \x120\n%ThpMessageType_ThpCodeEntryCommitment\x10\x80\x08\x1a\x04\x98\
    \xb5\x18\x01\x12/\n$ThpMessageType_ThpCodeEntryChallenge\x10\x81\x08\x1a\
    \x04\x90\xb5\x18\x01\x121\n&ThpMessageType_ThpCodeEntryCpaceTrezor\x10\
    \x82\x08\x1a\x04\x98\xb5\x18\x01\x122\n'ThpMessageType_ThpCodeEntryCpace\
    HostTag\x10\x83\x08\x1a\x04\x90\xb5\x18\x01\x12,\n!ThpMessageType_ThpCod\
    eEntrySecret\x10\x84\x08\x1a\x04\x98\xb5\x18\x01\x12&\n\x1bThpMessageTyp\
    e_ThpQrCodeTag\x10\x88\x08\x1a\x04\x90\xb5\x18\x01\x12)\n\x1eThpMessageT\
    ype_ThpQrCodeSecret\x10\x89\x08\x1a\x04\x98\xb5\x18\x01\x12'\n\x1cThpMes\
    sageType_ThpNfcTagHost\x10\x90\x08\x1a\x04\x90\xb5\x18\x01\x12)\n\x1eThp\
    MessageType_ThpNfcTagTrezor\x10\x91\x08\x1a\x04\x98\xb5\x18\x01\x1a\x04\
    \xd0\xf3\x18\x01\"\x04\x08\0\x10\x13\"\x04\x08\x15\x10\x19\"\x05\x08\x1c\
    \x10\xe7\x07\"\x06\x08\xe8\x07\x10\xe8\x07\"\x06\x08\xe9\x07\x10\xef\x07\
    \"\x06\x08\xf4\x07\x10\xf7\x07\"\x06\x08\xfc\x07\x10\xff\x07\"\x06\x08\
    \x85\x08\x10\x87\x08\"\x06\x08\x8a\x08\x10\x8f\x08\"\x06\x08\x92\x08\x10\
    \xcb\x08\"\t\x08\xcc\x08\x10\xff\xff\xff\xff\x07*G\n\x10ThpPairingMethod\
    \x12\x0f\n\x0bSkipPairing\x10\x01\x12\r\n\tCodeEntry\x10\x02\x12\n\n\x06\
    QrCode\x10\x03\x12\x07\n\x03NFC\x10\x04B;\n#com.satoshilabs.trezor.lib.p\
    rotobufB\x10TrezorMessageThp\x80\xa6\x1d\x01\
";
